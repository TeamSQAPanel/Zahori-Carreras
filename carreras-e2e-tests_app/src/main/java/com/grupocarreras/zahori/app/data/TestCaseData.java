...
public class TestCaseData {
    ...
    public TestCaseData(TestContext testContext) {
        ...
        testFlow = testCaseData.get(Static.FLUJO);
        testContext.logInfo("--- Flujo: " + testFlow);

        login = new Login(testCaseData);
        testContext.logInfo("--- " + login);

        recogida = new Recogida(testCaseData);
        testContext.logInfo("--- " + recogida);
    }
